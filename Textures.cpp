...
LPDIRECT3DINDEXBUFFER9 g_pIB = NULL;	//Ë÷Òý»º³åÇø
LPDIRECT3DTEXTURE9      g_pTexture = NULL; // Our texture
D3DXVECTOR3 vEyePt(0.0f, 0.0f, 0);
D3DXVECTOR3 vLookatPt(10.0f, 0.0f, 0);
...
HRESULT InitGeometry()
{
    ...
    if( FAILED( D3DXCreateTextureFromFile( g_pd3dDevice, L"screen.bmp", &g_pTexture ) ) )
    {
    ...
    if( FAILED( g_pVB->Lock( 0, 0, ( void** )&pVertices, 0 ) ) )
		return E_FAIL;
	pVertices[0].position = D3DXVECTOR3(50, -10, 10);
	pVertices[0].tu = 0;
	pVertices[0].tv = 0;
	pVertices[1].position = D3DXVECTOR3(50, 10, 10);
	pVertices[1].tu = 1;
	pVertices[1].tv = 0;
	pVertices[2].position = D3DXVECTOR3(50, -10, -10);
	pVertices[2].tu = 0;
	pVertices[2].tv = 1;
	pVertices[3].position = D3DXVECTOR3(50, 10, -10);
	pVertices[3].tu = 1;
	pVertices[3].tv = 1;
...
VOID Render()
{
	...
	g_pd3dDevice->SetTextureStageState( 0, D3DTSS_TEXCOORDINDEX, D3DTSS_TCI_CAMERASPACEPOSITION );
     ...
     //   g_pd3dDevice->DrawPrimitive( D3DPT_TRIANGLESTRIP, 0,2 );
		g_pd3dDevice->DrawIndexedPrimitive(D3DPT_TRIANGLESTRIP, 0, 0, 6, 0, 4);
